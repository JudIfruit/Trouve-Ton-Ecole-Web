        ...
        <div class="w-[calc(100%-30px)] flex">
          ...
          <div class="cursor-pointer w-[200px] ">
            <div class="flex items-center justify-start space-x-4" @click="toggleDrop">
              <img class="w-10 h-10 rounded-full border-2 border-gray-50" src="https://lh3.googleusercontent.com/a/ACg8ocLa5q-JHm8psd10-6Fcx1AtQHHXNOPqHqrDDBwW62EDTw=s360-c-no" alt="">
              <div class="font-semibold dark:text-gray-500 text-left">
                <div>JudIfruit ,Fondateur</div>
            ...
            <div v-show="showDropDown" class="absolute right-[10px] z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
              <div class="py-1 text-left" role="none">
                ...
                <a href="./settings" class="text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-0">Account settings</a>
